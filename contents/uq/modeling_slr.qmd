...
::: {.column-margin}
The statistical model used for residuals plays an important role in sound parameter inferences and projections [@brynjarsdottirLearningPhysicalParameters2014]. 
:::
