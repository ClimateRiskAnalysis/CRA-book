...
```{julia, label="slr-traceplot", cache=TRUE, fig.cap="Traceplots for the Metropolis-Hastings samples for the sea-level rise model."}
...
```{julia, label="slr-density", cache=TRUE, fig.cap="Marginal posterior densities for the Metropolis-Hastings samples for the sea-level rise model."}
quantile(chn)
...
```{julia, label="slr-pairs", cache=TRUE, fig.fullwidth=TRUE, fig.cap="Pairs plot for the posterior density for our calibrated sea-level rise model."}
using StatsPlots
...
```{julia, label="slr-corner", fig.fullwidth=TRUE, cache=TRUE, fig.cap="Corner plot for the posterior density for our calibrated sea-level rise model."}
...
```{julia, label="slr-hindcast", cache=TRUE, fig.margin=TRUE, fig.beforecode=TRUE, fig.cap="Sea-level rise hindcastsfrom 1880--2013 using our calibrated model. Reconstructed data from @Church2011-bj are black dots, the 90% model output credible interval is in blue."}
nsamples = 10000;
