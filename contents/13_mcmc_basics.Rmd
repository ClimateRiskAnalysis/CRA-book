...
```{julia, label="slr-pairs", cache=TRUE, fig.cap="Pairs plot for the posterior density for our calibrated sea-level rise model."}
using StatsPlots
...
```{julia, label="slr-corner", cache=TRUE, fig.cap="Corner plot for the posterior density for our calibrated sea-level rise model."}
